    ...
    function(t) {
        function e(t, a, r, n) {
            ...
            var g, l, s = 1,
                ...
                c = 0,
                u = r.rowHeight;
            for (f || (f = t.width() - 2), i = 0; i < a.length; i++)
                if (w.push(a[i]), (c += a[i][2] + r.margin) >= f) {
            ...
            s = {
                ...
                toString: function() {
                    ...
                    for (var e in this._ungap)
                        for (var n = v(e), r = 0, i = this._ungap[e]; r < i.length; r++) t.push(n + "=" + v(i[r]));
                    return t.join("&")
                }
            };
...
function wopen(url, w, h, target) {
    ...
    return function(u, D) {
        D = D || {};
        for (var w, t, y, p, r, C, B, o, q, A, z, x, v = "", s = []; w = a.exec(u);)
            if (y = w[0], B = (C = a.lastIndex) - y.length, !/[\/:]/.test(u.charAt(B - 1))) {
                do {
...
if ($(document).on("click", ".dd_box", (function() {
        ...
        $(".media_search").submit((function() {
            ...
            if (q && ($(this).attr("action", $(this).attr("action") + function(q) {
...
$(".linkify.ucg > a").attr("rel", "nofollow"), $('[data-href*="/accounts/favorite/"] *, [data-href*="/images/like/"] *, [data-href*="/videos/like/"] *').css("pointer-events", "none"),
    function() {
        function getClicks() {
            var clicks = [];
            try {
